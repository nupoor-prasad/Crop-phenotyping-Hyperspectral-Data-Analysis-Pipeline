...
#Import the hyperspectral data and create a folder using image info to save intermediate results
...
#Visualize image for finding valid outer bounds as per user defined Region of Interest 
...
#PCA for biophysical traits and hyperspectral indices in Year1
